...
CREATE TABLE property (
    ...
    type TINYINT UNSIGNED NOT NULL, -- venta/ alquiler/ valoracion
    status TINYINT UNSIGNED NOT NULL, -- disponible, reservada, alquilada, vendida, inactiva, prospecto
	...
	CONSTRAINT fk_city_1 FOREIGN KEY (city_id) 
...
CREATE TABLE file (
	property_id BIGINT UNSIGNED NOT NULL,
	file_id TINYINT UNSIGNED AUTO_INCREMENT NOT NULL,
